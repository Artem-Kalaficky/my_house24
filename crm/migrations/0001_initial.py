...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.date(2022, 7, 1), verbose_name='Дата')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(None, 'Выберите...'), ('paid', 'Оплачена'), ('p_paid', 'Частично оплачена'), ('unpaid', 'Неоплачена')], default='paid', max_length=16, verbose_name='Статус')),
                ('date_with', models.DateField(default=datetime.date(2022, 7, 1), verbose_name='Период с')),
                ('date_before', models.DateField(default=datetime.date(2022, 7, 1), verbose_name='Период до')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.BigIntegerField(default=crm.models.personal_account_number, unique=True, verbose_name='Номер лицевого счета')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='грн', max_length=4, verbose_name='Валюта')),
            ],
            options={
                'verbose_name': 'Услуга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cost_for_unit', models.DecimalField(decimal_places=2, max_digits=4, verbose_name='Цена за ед., грн.')),
                ('expense', models.IntegerField(verbose_name='Расход')),
                ('full_cost', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Стоимость, грн.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cost_for_unit', models.DecimalField(decimal_places=2, max_digits=4, verbose_name='Цена')),
            ],
            options={
