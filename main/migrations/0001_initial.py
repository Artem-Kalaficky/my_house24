    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.aboutpage', verbose_name='О нас')),
            ],
            options={
                'verbose_name': 'Фото',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.mainpage', verbose_name='Страница наших услуг')),
            ],
            options={
